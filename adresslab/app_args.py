...
def _args_md():
    ...
    parser.add_argument('--temperature', default=298.0, type=float, help='Temperature')
    ...
    parser.add_argument('--initial_step', default=0,
                        ...
                        type=int)
    parser.add_argument('--exclusion_list', default=None, help='The exclusion list')

    adress_group = parser.add_argument_group('AdResS settings')
    adress_group.add_argument('--ex', help='Size of explicit region', type=float)
    adress_group.add_argument('--hy', help='Size of hybrid region', type=float)
